...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <a href="{{ route('admin.kontak.index') }}" class="text-gray-600 hover:text-primary-600 mb-2 inline-flex items-center">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_perusahaan" id="nama_perusahaan" value="{{ old('nama_perusahaan', $kontak->nama_perusahaan ?? '') }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('nama_perusahaan') border-red-500 @enderror">
            ...
            <div class="mt-6">
                ...
                <textarea name="alamat" id="alamat" rows="3" required
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('alamat') border-red-500 @enderror">{{ old('alamat', $kontak->alamat ?? '') }}</textarea>
                @error('alamat')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div>
                        <label for="facebook" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fab fa-facebook text-primary-600 mr-1"></i>Facebook
                        </label>
