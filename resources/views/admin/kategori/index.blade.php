...
<div class="bg-linear-to-r from-primary-700 to-primary-900 rounded-2xl shadow-xl p-8 mb-8">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-primary-100">Kelola kategori produk bearing Anda</p>
        </div>
        <div class="md:block">
            <div class="w-20 h-20 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                <i class="fas fa-layer-group text-primary-900 text-4xl"></i>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-md p-4 mb-8">
    <form action="{{ route('admin.kategori.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('admin.kategori.index') }}" class="px-4 py-2.5 bg-gray-500 text-white rounded-lg font-semibold hover:bg-gray-600 transition-all">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <a href="{{ route('admin.kategori.create') }}" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-all">
