...
@section('content')
    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Tambahkan metode pembayaran baru</p>
        </div>
    </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="tipe" id="tipe" required
                        ...
                        <option value="transfer" {{ old('tipe') == 'transfer' ? 'selected' : '' }}>Transfer Bank</option>
                        <option value="cod" {{ old('tipe') == 'cod' ? 'selected' : '' }}>COD (Bayar di Tempat)</option>
                ...
                <div id="bank-fields" class="md:col-span-2 grid md:grid-cols-3 gap-6 {{ old('tipe') == 'transfer' ? '' : 'hidden' }}">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Nama Bank <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="bank_nama" value="{{ old('bank_nama') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_atas_nama" value="{{ old('bank_atas_nama') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="instruksi" rows="4"
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 @error('instruksi') border-red-500 @enderror">{{ old('instruksi') }}</textarea>
                    @error('instruksi')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
