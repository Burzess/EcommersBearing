                ...
                <div class="grid md:grid-cols-5 gap-4">
                    <div>
                        ...
                        @error('harga')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-500 text-xs mt-1"><i class="fas fa-info-circle mr-1"></i>Harga jual normal
                            produk</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="stok" value="{{ old('stok', 0) }}" required min="0"
                                inputmode="numeric" oninput="stripLeadingZeros(this)"
                        ...
                        @error('stok')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-500 text-xs mt-1"><i class="fas fa-info-circle mr-1"></i>Jumlah stok tersedia
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        @error('min_stok')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-500 text-xs mt-1"><i class="fas fa-info-circle mr-1"></i>Batas peringatan stok
                            rendah</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="berat" value="{{ old('berat') }}" required
                                min="0"
                        ...
                        @error('berat')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-500 text-xs mt-1"><i class="fas fa-info-circle mr-1"></i>Untuk kalkulasi
                            ongkir</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="inner_diameter" value="{{ old('inner_diameter') }}"
                            min="0"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="outer_diameter" value="{{ old('outer_diameter') }}"
                            min="0"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div x-data="produkImageUploader()" x-cloak class="space-y-3">
                            ...
                            <input type="file" name="images[]" x-ref="fileInput" multiple
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3"
                                ...
                                <template x-for="(item, idx) in previews" :key="item.id">
                                    <div
                                        ...
                                        {{-- Tombol hapus --}}
                                        <button type="button" @click.stop="removeAt(idx)"
                                        ...
                                        {{-- Nama file --}}
                                        <div
                                            class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/70 to-transparent p-1.5">
